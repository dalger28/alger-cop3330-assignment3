...
import java.util.Scanner;
    public class ex43
    {
        public static void main(String[] args)
        {
            ...
            System.out.print("Do you want a folder for Windows? ");
            windows = SC.next().charAt(0);
            ...
            if(websiteCreated)
            {
                ...
                try
                {
                    ...
                    if(windows == 'y' || js == 'Y')
                    {
                        File windowsFolder = new File(currentPath+"\\js");
                        boolean windowsCreated = windowsFolder.mkdir();

                        if(windowsCreated)
                        {
                            System.out.println("Created " + windowsFolder+"\\");
                        }
                        else
                        {
                            System.out.println("Windows folder not created!!");
                        }
